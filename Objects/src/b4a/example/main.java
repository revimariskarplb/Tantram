...
public static void killProgram() {
 ...
 {
            Activity __a = null;
            if (modulloginadmin.previousOne != null) {
				__a = modulloginadmin.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(modulloginadmin.mostCurrent == null ? null : modulloginadmin.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (moduldashboard.previousOne != null) {
				__a = moduldashboard.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(moduldashboard.mostCurrent == null ? null : moduldashboard.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
RDebugUtils.currentLine=1572864;
 //BA.debugLineNum = 1572864;BA.debugLine="Private Sub BtnAdmin_Click";
RDebugUtils.currentLine=1572865;
 //BA.debugLineNum = 1572865;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
RDebugUtils.currentLine=1572866;
 //BA.debugLineNum = 1572866;BA.debugLine="StartActivity(ModulLoginAdmin)";
